...
// 你的k800的名字，不支持中文
#define MY_CUSTOM_MENDEL_NAME "MY K800"
...
#define MY_DELTA_DIAGONAL_ROD 210.14//220.32//215.78 // 215.5//217mm

// Horizontal offset from middle of printer to smooth rod center.
// 打印头到滑杆水平距离
#define MY_DELTA_SMOOTH_ROD_OFFSET 152.5//151.6 // mm
...
// 滑车球中心到滑杆水平距离
#define MY_DELTA_CARRIAGE_OFFSET 19.6 // mm 9 22.7//6.5 20.2

// Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
// 打印半径？
#define MY_DELTA_PRINTABLE_RADIUS 65.0
...
#define MY_MANUAL_Z_HOME_POS 293.0//211.5//221.3//211  60 227.2  jhead 234.3// For delta: Distance between nozzle and print surface after homing.
